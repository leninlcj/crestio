        ...
        <div className="bg-cream flex" style={{ minHeight: '420px' }}>
          <aside className="hidden md:flex w-44 flex-col bg-surface border-r border-rule px-3 py-4 gap-1">
            ...
            <div className="mt-auto px-2 py-1.5 text-2xs text-ink-soft border-t border-rule pt-3 mt-3">
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded-full bg-forest/20 flex items-center justify-center text-forest font-medium text-[8px]">SK</div>
                <span>Sarah K.</span>
              </div>
            </div>
          </aside>
          ...
          <main className="flex-1 p-4 md:p-6 space-y-4">
            <div>
              ...
              <div className="font-display text-lg md:text-xl tracking-tightest text-ink">Good morning, Sarah.</div>
            </div>
