  ...
  return (
    <div className="min-h-screen bg-cream text-ink">
      ...
      <main className="px-6 md:px-12 py-10 max-w-3xl mx-auto">
        <div className="mb-6">
          <div className="text-2xs uppercase tracking-widest text-ink-muted mb-2">Notifications</div>
          <h1 className="font-display text-4xl tracking-tightest">Your notifications</h1>
        </div>
        <NotificationList />
      </main>
    </div>
