  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        `The fee for each student is confirmed in writing when you accept them. The schedule: Years 7 to 10 Mathematics $${TUTOR_PAY_BANDS.years_7_10.online} online and $${TUTOR_PAY_BANDS.years_7_10.inHome} in-home; Years 11 and 12 (Standard 2, Advanced, Extension 1, Physics) $${TUTOR_PAY_BANDS.hsc.online} and $${TUTOR_PAY_BANDS.hsc.inHome}; Extension 2 $${TUTOR_PAY_BANDS.ext2.online} and $${TUTOR_PAY_BANDS.ext2.inHome}. Per hour of lesson delivered; in-home fees include your travel.`,
